    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            controller.showHabbitsListScreen();
          },
        ),
      ),
      body: Padding(
                  ...
                  children: [
                    ...
                    LinearProgressIndicator(
                      value: habbit.targetDays > 0
                          ? (habbit.currentProgress / habbit.targetDays).clamp(0.0, 1.0)
                          : 0.0,
                      minHeight: 8,
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: habbit.isGoalReached ? Colors.green : Colors.grey[600],
                        fontWeight: habbit.isGoalReached ? FontWeight.bold : FontWeight.normal,
                      ),
                    ),
                  ],
                ),
              ...
              child: habbit.events.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final event = habbit.events[habbit.events.length - 1 - index];
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              ...
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: isAck ? Colors.green[700] : Colors.red[700],
                              ),
                            ),
                            subtitle: Text(
